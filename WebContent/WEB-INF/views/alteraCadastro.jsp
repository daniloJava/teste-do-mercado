...
<title>Alteração de Mercadorias de Mercadorias.</title>
<!-- Bootstrap CSS -->
	...
	<div class="container">
		<form class="form-horizontal" method="post" action="adicionaNegociacao">
			...
			<div class="form-group">
				<h1 >Altera negociação - ${negocia.codigoDaMercadoria}</h1>
				...
				<div class="col-sm-10">
					...
					<div class="radio" >
						<label> <input type="radio" name="tipoDaConta"
							id="blankRadio1" value="Compra" disabled>Compra
						</label> <label> <input type="radio" name="tipoDaConta"
							id="blankRadio1" value="Venda" disabled>Venda
						</label>
					</div>
				</div>
				<!-- fim tipo de Negocio -->
			...
			<div class="form-group">
				...
				<div class="col-sm-10">
					<input name="codigoDaMercadoria" type="number" class="form-control" id="inputCodMercadoria"
						value=${negocia.codigoDaMercadoria}  max="9999" min="1"  disabled>
				</div>
			</div>
			...
			<div class="form-group">
				...
				<div class="col-sm-10">
					<input type="text" class="form-control" id="exampleInputName2"
						value=${negocia.nomeDaMercadoria} required value="" name="nomeDaMercadoria">
				</div>
			</div>
			<!-- fim Nome. -->
			...
			<div class="form-group">
				...
				<div class="col-sm-2">
					<input type="number" class="form-control" id="exampleInputQTD" value=${negocia.qtdMercadoria}
				...
				<div class="form-group">
					...
					<div class="col-sm-2">
						<input class="form-control" type="number" 
							value=${negocia.preco} name="preco">
					</div>
				</div>
				<!-- Fim preçoa. -->
